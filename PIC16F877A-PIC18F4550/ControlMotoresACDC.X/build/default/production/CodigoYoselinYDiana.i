...
# 5 "CodigoYoselinYDiana.c" 2
# 19 "CodigoYoselinYDiana.c"
const int Rs = 14;
const int En = 13;
const int RW = 12;
...
void ModoEncendido(void)
{
 ...
 {
  case 0:
   digitalWrite(MotorAC,0);
   MotorDC(0);
            lcdPrint("DC-OFF/AC-OFF");
  break;
  case 1:
   digitalWrite(MotorAC,1);
   MotorDC(2);
...
void MotorDC(unsigned int Mode)
{
 ...
 {
  case 1:
   digitalWrite(MotorDCN,1);
   digitalWrite(MotorDCP,0);
  break;
  case 2:
   digitalWrite(MotorDCN,0);
   digitalWrite(MotorDCP,1);
  break;
  case 0:
   digitalWrite(MotorDCN,0);
   digitalWrite(MotorDCP,0);
