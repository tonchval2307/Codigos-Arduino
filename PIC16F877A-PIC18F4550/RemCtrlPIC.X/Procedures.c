...
void SPISlaveInit(void)
{
    ...
    SSPSTATbits.SMP = 0;
    SSPCON1bits.SSPEN = 1;
    TRIS_SCK = 1;  //Serial Clock
    TRIS_SDI = 1;   //Seral Data Input MOSI
    TRIS_SDO = 0;   //Serial Data Out MISO
    TRIS_CS = 1; //Slave Select
    SSPCON1bits.SSPM3 = 0;
    SSPCON1bits.SSPM2 = 1;
    SSPCON1bits.SSPM1 = 0;
    SSPCON1bits.SSPM0 = 0;
