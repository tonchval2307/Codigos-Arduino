/* 
 * File:   Tonche_16F877.h
 * Author: Carlos-Tonche
 *
 * Created on February 28, 2018, 6:18 PM
 */

#ifndef TONCHE_16F877_H
#define	TONCHE_16F877_H
...
/*
 *  Paso 1:
 *      generar procedimientos para configurar a voluntad los pines de entrada
 *      y salida.
 * Paso 2:
 * Generar procedimientos para leer los estados de los pines de entrada y
 * y salida.
 *
 */
void portaMode(int pin, char mode)
